...
<div :class="[$style.root, { [$style.withWallpaper]: wallpaper }]">
	...
	<div v-if="isMobile" :class="$style.nav">
		...
		<button :class="[$style.navButton, { [$style.active]: mainRouter.currentRoute.value.name === 'explore' }]" class="_button" @click="mainRouter.currentRoute.value.name === 'explore' ? top() : mainRouter.replace('/explore')"><i :class="$style.navButtonIcon" class="ti ti-bell"></i></button>

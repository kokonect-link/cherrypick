...
<div>
	...
	<button v-if="editMode" v-vibrate="prefer.s['vibrate.on.system'] ? 5 : []" class="_textButton" style="font-size: 0.9em;" @click="editMode = false"><i class="ti ti-check"></i> {{ i18n.ts.editWidgetsExit }}</button>
	<button v-else v-vibrate="prefer.s['vibrate.on.system'] ? 5 : []" class="_textButton" data-cy-widget-edit :class="$style.edit" style="font-size: 0.9em;" @click="editMode = true"><i class="ti ti-pencil"></i> {{ i18n.ts.editWidgets }}</button>
</div>
</template>

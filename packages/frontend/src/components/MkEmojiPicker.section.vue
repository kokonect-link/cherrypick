...
<section v-if="!hasChildSection" style="border-radius: 6px; border-bottom: 0.5px solid var(--divider);">
...
<section v-else style="border-radius: 6px; border-bottom: 0.5px solid var(--divider);">
	<header class="_acrylic" @click="shown = !shown">

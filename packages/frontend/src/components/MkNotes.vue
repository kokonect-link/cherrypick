	...
	<template #default="{ items: notes }">
		...
		>
			<template v-for="(note, i) in notes" :key="note.id">
				...
				<MkNote v-else :class="$style.note" :note="note" :withHardMute="true" :notification="notification" :forceShowReplyTargetNote="forceShowReplyTargetNote"/>
			</template>
		</component>
	</template>
</MkPagination>
...
import { useTemplateRef, onMounted, TransitionGroup } from 'vue';

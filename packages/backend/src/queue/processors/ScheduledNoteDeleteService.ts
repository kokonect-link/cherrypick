...
import { ScheduledNoteDeleteJobData } from '../types.js';
...
export class ScheduledNoteDeleteProcessorService {
	...
	constructor(
		...
		this.logger = queueLoggerService.logger.createSubLogger('scheduled-note-delete');
	}

	@bindThis
	public async process(job: Bull.Job<ScheduledNoteDeleteJobData>) {

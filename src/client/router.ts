...
const defaultRoutes = [
	...
	{ path: '/gallery', name: 'gallery', component: page('gallery/index') },
	...
	{ path: '/channels', name: 'channels', component: page('channels') },
	...
	{ path: '/my/groups', name: 'groups', component: page('my-groups/index') },
	...
	{ path: '/admin/ads', name: 'ads', component: page('admin/ads') },

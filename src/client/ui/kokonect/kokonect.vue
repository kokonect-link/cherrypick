...
<div class="mk-app" :class="{ wallpaper, isMobile }">
	...
	<div class="buttons" v-if="isMobile">
		...
		<button class="button home _button" @click="$route.name === 'index' ? top() : $router.replace('/')"><i class="fas fa-home"></i></button>
		<button class="button search _button" @click="$route.name === 'search' ? top() : $router.replace('/my/notifications')"><i class="fas fa-search"/></button>
		<button class="button notifications _button" @click="$route.name === 'notifications' ? top() : $router.replace('/my/notifications')"><i class="fas fa-bell"></i><span v-if="$i.hasUnreadNotification" class="indicator"><i class="fas fa-circle"></i></span></button>
		<button class="button tab _button" @click="$route.name === 'messaging' ? top() : $router.replace('/my/messaging')"><i class="fas fa-comments"></i><span v-if="$i.hasUnreadMessagingMessage" class="indicator"><i class="fas fa-circle"></i></span></button>

...
<div class="mk-app" :class="{ wallpaper, isMobile }">
	...
	<div class="buttons" v-if="isMobile">
		...
		<button class="button search _button" @click="search" :class="{ active: search }"><i class="fas fa-search"/></button>
		...
		<button class="button widget _button" @click="widgetsShowing = true" :class="{ active: widgetsShowing = true }"><i class="fas fa-layer-group"></i></button>

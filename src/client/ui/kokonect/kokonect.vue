...
<div class="mk-app" :class="{ wallpaper, isMobile }">
	...
	<div class="floatbtn" v-if="isMobile && ($route.name === 'index' || $route.replace('/my/notifications') || $route.replace('/my/messaging'))">
		<button v-if="$route.name === 'index' || $route.replace('/my/notifications')" class="post _buttonPrimary" @click="post()"><i class="fas fa-pencil-alt"/></button>
		<button v-if="$route.replace('/my/messaging')" class="post _buttonPrimary" @click="post()"><i class="fas fa-pencil-alt"/></button>
  </div>
	...
	<div class="buttons" v-if="isMobile">
		...
		<button class="button notifications _button" @click="$router.replace('/my/notifications')"><i class="fas fa-bell"></i><span v-if="$i.hasUnreadNotification" class="indicator"><i class="fas fa-circle"></i></span></button>
		<button class="button tab _button" @click="$router.replace('/my/messaging')""><i class="fas fa-comments"></i><span v-if="$i.hasUnreadMessagingMessage" class="indicator"><i class="fas fa-circle"></i></span></button>

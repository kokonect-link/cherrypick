	...
	<template v-if="info">
		...
		<div class="buttons_L">
			<template v-if="isMobile">
				<button class="_button button_L" v-if="!(withBack && canBack)" v-on:click="showDrawer" v-tooltip="$ts.menu" ref="navButton"><Fa :icon="faBars"/><i v-if="navIndicated"><Fa :icon="faCircle"/></i></button>

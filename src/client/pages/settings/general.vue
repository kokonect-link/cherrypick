...
<FormBase>
	<FormGroup>
		...
		<FormSwitch v-if="$i.isPatron" v-model="removeAds">{{ $ts.removeAds }}</FormSwitch>
	</FormGroup>
	...
	<FormGroup>
		...
		<FormSwitch v-model="confirmBeforePost">{{ $ts.confirmBeforePost }}
	...
	<FormSelect v-if="isFriendlyUI" v-model="newNoteNotiBehavior">

...
### NOTE
- Misskey에서의 설정 기능 개편에 대응하는 과정에서 기존에 존재했던 일부 설정이 누락되거나, 기능이 정상적으로 작동하지 않을 수 있습니다.
	혹시나 이러한 문제를 발견하셨다면, [문제 보고](https://github.com/kokonect-link/cherrypick/issues/new?template=01_bug-report.yml)를 통해 버그를 리포트하실 수 있습니다.

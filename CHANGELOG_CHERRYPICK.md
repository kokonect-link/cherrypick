...
- Feat: 메시지 연합
  - 이제 메시지 기능이 대응하는 리모트 서버와 연합됩니다.
  - 메시지 연합을 대응하는 서버에서는 그룹 채팅룸도 사용할 수 있으며, 리모트 서버로 초대를 보내거나 수락할 수 있습니다.
  ...
  - 메시지 연합이 지원되지 않는 서버의 사용자에게는 사용자 지정 노트를 통해 전송되며, 상대방이 여기에 답장하면 메시지에 표시됩니다.
